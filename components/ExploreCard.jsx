...
const ExploreCard = ({id, imgUrl, title, index, active, handleClick}) => (
  ...
  >
    ...
    {active !== id ? (
      <h3 className='font-semibold sm:text-[26px] text-[18px] text-white absolute z-0 lg:bottom-20 lg:rotate-[-90deg]'>{title}</h3>
    ):(
      <div className='absolute bottom-0 p-8 flex justify-start
